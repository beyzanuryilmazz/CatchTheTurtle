...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YOUR_USERNAME/catch-the-turtle.git](https://github.com/YOUR_USERNAME/catch-the-turtle.git)](https://github.com/beyzanuryilmazz/CatchTheTurtle.git)
   cd catch-the-turtle
